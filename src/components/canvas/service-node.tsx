...
function ServiceNodeComponent({ data, selected }: NodeProps) {
  ...
  return (
    <div
      className={`service-node-card relative rounded-xl border border-[oklch(0.3_0.005_270)] bg-[oklch(0.14_0.005_270)] p-3 min-w-[320px] max-w-[340px] shadow-xl transition-all duration-200 ${
